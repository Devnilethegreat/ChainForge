...
class ChainForge:
    """Main orchestrator for ChainForge."""

    def __init__(self, verbose: bool = False):
        self.verbose = verbose
        self.threshold = float(os.getenv("THRESHOLD", "0.75"))
        self.core = ChainForgeCore(threshold=self.threshold, verbose=verbose)
    ...
    def run(self) -> bool:
        try:
            self.logger.info("Starting ChainForge processing pipeline")
...
def main():
    parser = argparse.ArgumentParser(description="ChainForge")
...
# revision 18 (2025-01-12): review pass
